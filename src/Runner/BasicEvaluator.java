...
import LISP.ASTList;
import LISP.ASTree;
import LISP.BlockStmnt;
import LISP.IfStmnt;
import LISP.NegativeExpr;
import LISP.NullStmnt;
import LISP.NumberLiteral;
import LISP.StoneException;
import LISP.StringLiteral;
import LISP.Token;
import LISP.Parser.Operators;
		...
		public static class BinaryEx extends BinaryExpr {
			...
			protected Object computeOp(Object left, String op, Object right) {
				if (left instanceof Integer && right instanceof Integer) {
					...
					return StringEx.valueOf(left) + String.valueOf(right);
				else if (op.equals("==")) {
					if (left == null)
